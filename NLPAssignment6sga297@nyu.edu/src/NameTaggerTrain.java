...
public class NameTaggerTrain {
    ...
    public static void main(String[] args) throws IOException {
        File filetoread = new File("FeatureBuilderTrainDataset");
        ...
        NameTaggerTrain traindata = new NameTaggerTrain();
        traindata.datavalueinitialise();
        BufferedReader bufferedreader = new BufferedReader(new FileReader(args[0]));
        String linevalue;
        while ((linevalue = bufferedreader.readLine()) != null) {
        	if(linevalue.equals("-DOCSTART-\t-X-\tO\tO")) {  // whenever a new doc is starting
        		bwriter.write(linevalue);
        		bwriter.newLine();
            }else if(linevalue.length() == 0){
            	if(traindata.ppostag =="" && traindata.pchunk == ""){   //whenever a new doc is starting these values will be empty and hence prints an empty line
            		bwriter.write(linevalue);
            		bwriter.newLine();
            		traindata.datavalueinitialise();
            	}else{  //when newline starts but not in a new doc then we need to initialise the nextvalues to nil
            		traindata.npostag = "";
            		traindata.nchunk = "";
            		traindata.nnametag = "";
            	...
            	if(traindata.ppostag == "" && traindata.pchunk == "") {
                    ...
                    traindata.cnametag = currentvalues[3];
                    ...
                    traindata.nnametag = nextvalues[3];
	...
	public void datavalueinitialise() {
		// TODO Auto-generated method stub
		pword = "";
		ppostag = "";
		pchunk = "";
